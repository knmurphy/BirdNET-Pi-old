...
def _dashboard_content():
    ...
    return Div(
        # Stats widgets with HTMX polling
        Div(
            Div(
        ...
        Div(
            P("Waiting for detections…", id="feed-empty",
              style="color: var(--text3); font-family: var(--font-mono); font-size: 12px;"),
            id="live-feed", cls="live-feed",
        ),
    )
